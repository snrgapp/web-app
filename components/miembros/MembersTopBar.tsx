...
export function MembersTopBar() {
  return (
    <header className="sticky top-0 z-40 bg-zinc-50">
        ...
        <div className="flex-1 flex justify-end">
          <div className="relative w-full max-w-xs">
            ...
            <Input
              type="search"
              placeholder="Buscar..."
              className="pl-9 bg-white border-zinc-200 w-full"
            />
          </div>
        </div>
        <div className="lg:w-80 flex items-center justify-start gap-2 flex-shrink-0">
          <NotificationsBubble />
        </div>
      </div>
    </header>
