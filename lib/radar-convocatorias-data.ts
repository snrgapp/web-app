...
export const CONVOCATORIAS: Convocatoria[] = [
  ...
  },
  {
    ...
    title: 'Líneas de crédito y convocatorias para MIPYMES',
    summary:
      'Financiación de desarrollo empresarial, modernización y crecimiento para empresas colombianas, incluyendo líneas de redescuento y programas con aliados.',
    requirement: 'Empresa constituida en Colombia con capacidad de crédito y RUT activo.',
    amountLabel: 'Tipo de recurso',
    amountValue: 'Crédito de desarrollo y cofinanciación',
    funding: 'cofinanciacion',
    stage: 'mediana',
    sector: 'multi',
    region: 'nacional',
    tags: ['Crédito blando', 'Etapa mediana', 'MIPYMES', 'Nacional'],
    urgency: 'open',
    urgencyLabel: 'Consultar convocatoria vigente',
    keywords: 'bancoldex credito mipyme desarrollo',
    accent: 'slate',
    basesUrl: 'https://www.bancoldex.com/',
  },
  {
    id: 'finagro',
    initials: 'FG',
    ...
    title: 'Instrumentos de financiación agroindustrial',
    summary:
      'Líneas e incentivos para productores y empresas de la ruralidad: capital de trabajo, inversión y programas de fomento agropecuario.',
    requirement: 'Actividad agropecuaria, acuícola o agroindustrial elegible ante Finagro.',
    amountLabel: 'Enfoque',
    amountValue: 'Crédito e incentivos del sector agro',
    funding: 'cofinanciacion',
    stage: 'ambas',
    sector: 'agro',
    region: 'nacional',
    tags: ['Agroindustria', 'Crédito de fomento', 'Nacional'],
    urgency: 'open',
    urgencyLabel: 'Consultar línea vigente',
    keywords: 'finagro agro credito semilla rural',
    accent: 'yellow',
    basesUrl: 'https://www.finagro.com.co/',
  },
  {
    ...
    title: 'Programas de productividad y encadenamientos',
    summary:
      'Convocatorias de asistencia técnica, sofisticación y productividad para empresas de sectores priorizados a nivel nacional.',
    requirement: 'Empresa formal con operación en Colombia y encaje en la convocatoria publicada.',
    amountLabel: 'Beneficio principal',
    amountValue: 'Asistencia técnica y cofinanciación',
    funding: 'cofinanciacion',
    stage: 'mediana',
    sector: 'multi',
    region: 'nacional',
    tags: ['Productividad', 'Etapa mediana', 'Multisectorial'],
    urgency: 'open',
    urgencyLabel: 'Consultar convocatoria vigente',
    keywords: 'colombia productiva mincit cofinanciacion',
    accent: 'black',
    basesUrl: 'https://www.colombiaproductiva.com/',
  },
  {
    id: 'mincit',
    initials: 'MT',
    ...
    summary:
      'Llamados públicos del Ministerio para fortalecimiento empresarial, turismo y desarrollo productivo en Colombia.',
  ...
  },
  {
    ...
    summary:
      'Acompañamiento y convocatorias para exportar, atraer inversión y escalar modelos con tracción hacia mercados internacionales.',
  ...
  },
  {
    ...
    summary:
      'Convocatorias y programas de las cámaras de comercio para formalización, productividad y emprendimiento en todo el país.',
    ...
    accent: 'slate',
    basesUrl: 'https://www.confecamaras.org.co/',
  },
]
