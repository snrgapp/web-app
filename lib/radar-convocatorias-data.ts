...
export const RADAR_REVIEWED_AT = '2026-09-20'
...
/**
 * Fichas contrastadas el 2026-09-20 en listados públicos (sin login).
...
export const CONVOCATORIAS: Convocatoria[] = [
  ...
  },
  {
    ...
    summary:
      'Términos oficiales 2026: financiar creación o fortalecimiento de iniciativas en todos los sectores, individual o asociativa. Presupuesto de la convocatoria: $18.000 millones. Cerró el 6 de abril de 2026. El listado de “vigentes” del Fondo Emprender sigue mostrando regionales (p. ej. 165 Guatapé) cuyas fichas ya marcaron cierre; no hay una nacional 2026 nueva verificada en esta pasada.',
  ...
  },
  {
    ...
    summary:
      'Ruta oficial MinTIC–MinCIT–iNNpulsa para 110 empresas digitales con producto validado: 26 horas de asistencia y toolkit de hasta $2.000.000 COP para la mitad de los beneficiarios. El listado iNNpulsa la marca cerrada (plazo público de postulación: 22 de mayo de 2026). Apps.co no respondió en esta pasada (tiempo de espera); se conserva la ficha iNNpulsa.',
    requirement:
  ...
  },
  {
    ...
    summary:
      'Instrumento público 2026 de Finagro para crédito agropecuario con tasas de interés reducidas, publicado con circular externa 25 de 2026. No es capital no reembolsable: se tramita con intermediarios financieros. Ficha oficial contrastada el 20 de septiembre de 2026.',
  ...
  },
  {
    ...
    summary:
      'En esta pasada el listado /convocatorias de MinCIT respondió 404. Se conserva la ficha y el último enlace público válido del ministerio; no se añadió una convocatoria inventada.',
  ...
  },
  {
    ...
    summary:
      'Acompañamiento para exportar, atraer inversión y escalar oferta con tracción internacional. En esta pasada no apareció una convocatoria fechada de semilla o aceleración en el listado público; se conserva la ficha y el último enlace válido.',
  ...
  },
  {
    ...
    summary:
      'Página pública de Confecámaras con los programas de la red de cámaras de comercio (formalización, productividad y emprendimiento). No se verificó una convocatoria nacional fechada distinta en esta pasada.',
