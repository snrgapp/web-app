...
export const RADAR_REVIEWED_AT = '2026-09-26'
...
/**
 * Fichas contrastadas el 2026-09-26 en listados públicos (sin login).
...
export const CONVOCATORIAS: Convocatoria[] = [
  {
    ...
    amountHint: '60 cupos · cierre 2 oct 2026',
    funding: 'aceleradora',
    stage: 'ambas',
    sector: 'comercio',
    region: 'nacional',
  ...
  },
  {
    ...
    urgency: 'soon',
    urgencyLabel: 'Cierra en 14 días',
  ...
  {
    id: 'minciencias-053-2026-cordoba',
    initials: 'MC',
    entity: 'MinCiencias',
    entitySub: 'Convocatoria 53 — SGR CTeI Córdoba',
    title: 'CTeI Córdoba Plan Bienal 2025-2026 — Corte 2',
    summary:
      'Cofinanciación de proyectos de reactivación agrícola, social y ambiental en Córdoba, alineados con el Plan Bienal CTeI 2025-2026. Bolsa publicada: $28.094.792.444. Apertura: 25 de septiembre de 2026. Cierre: 23 de octubre de 2026, 4:00 p. m.',
    requirement:
      'Alianza SNCTI con IES con domicilio principal en Córdoba, dos entidades territoriales (una debe ser el Departamento), un actor del sector productivo y una organización de sociedad civil del departamento.',
    amountLabel: 'Recursos de la convocatoria',
    amountValue: '$28.094.792.444 COP',
    amountHint: 'Cierre 23 oct 2026 · 4:00 p. m.',
    funding: 'cofinanciacion',
    stage: 'mediana',
    sector: 'agro',
    region: 'caribe',
    tags: ['Cofinanciación', 'CTeI', 'Córdoba', 'SGR', 'Cierra 23 oct 2026'],
    urgency: 'open',
    urgencyLabel: 'Cierre: 23 de octubre',
    keywords: 'minciencias 053-2026 cordoba sgr ctei plan bienal corte 2',
    accent: 'black',
    closesAt: '2026-10-23',
    basesUrl:
      'https://minciencias.gov.co/convocatorias/plan-convocatorias-asctei-2025-2026/convocatoria-para-el-fortalecimiento-capacidades-0',
  },
  {
