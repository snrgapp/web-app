...
export default function PerrenqueNetworkingLandingPage() {
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-between p-8 font-sans relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm mt-8 sm:mt-12 h-[300px] flex justify-center z-10">
        <motion.div
          ...
          className="absolute w-[280px] h-[160px] bg-[#FFD600] rounded-[30px] p-6 shadow-lg border-2 border-[#1a1a1a]"
          style={{ zIndex: 1 }}
        >
          <div className="flex flex-col gap-4">
            <Lightbulb className="w-6 h-6 text-black" />
            <div className="w-24 h-6 bg-[#1a9fd4] rounded-full border-2 border-black" />
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute w-[300px] h-[170px] bg-[#1a9fd4] rounded-[30px] p-6 shadow-xl border-2 border-[#1a1a1a]"
          style={{ zIndex: 2 }}
        >
          <div className="flex flex-col gap-4">
            <Rocket className="w-6 h-6 text-[#FFD600]" />
            <div className="w-32 h-6 bg-[#FFD600] rounded-full border-2 border-black" />
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute w-[320px] h-[180px] bg-gradient-to-b from-[#FFD600] to-[#ffc200] rounded-[35px] p-8 shadow-2xl border-2 border-[#1a1a1a]"
          style={{ zIndex: 3 }}
        >
          <div className="flex justify-between items-start">
            <div className="flex flex-col gap-5">
              <Zap className="w-7 h-7 text-black fill-black" />
              <div className="w-36 h-8 bg-[#1a9fd4] rounded-full border-2 border-black" />
            </div>
            <div className="bg-white/30 p-2 rounded-full border border-black/20 flex items-center justify-center">
      ...
      <div className="w-full max-w-sm px-4 mb-12 z-30">
        <motion.button
          onClick={() => router.push('/networking/perrenque/verify')}
      ...
      <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-white via-white/70 to-transparent z-[5] pointer-events-none" />
    </div>
  )
}
